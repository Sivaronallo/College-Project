...
namespace CollegeProject.Infrastructure.Migrations
{
    ...
    [Migration("20230411155520_RefreshToken")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CollegeProject.Core.Entities.Department", b =>
                {
                    ...
                    b.ToTable(tb => tb.IsTemporal(ttb =>
                            {
                                ttb.UseHistoryTable("DepartmentsHistory", "Master");
                                ttb
                                    .HasPeriodStart("PeriodStart")
                                    .HasColumnName("PeriodStart");
                                ttb
            ...
            modelBuilder.Entity("CollegeProject.Core.Entities.Designation", b =>
                {
                    ...
                    b.ToTable("Designations", "Master");

                    b.ToTable(tb => tb.IsTemporal(ttb =>
                            {
                                ttb.UseHistoryTable("DesignationsHistory", "Master");
                                ttb
                                    .HasPeriodStart("PeriodStart")
                                    .HasColumnName("PeriodStart");
                                ttb
            ...
            modelBuilder.Entity("CollegeProject.Core.Entities.Message.EmailLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CollegeProject.Core.Entities.CollegeUser", b =>
                {
                    ...
                    b.OwnsMany("CollegeProject.Core.Entities.RefreshToken", "RefreshTokens", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("int");
                            ...
                            b1.Property<string>("CollegeUserId")
                                .IsRequired()
                                .HasColumnType("nvarchar(450)");
                            ...
                            b1.HasIndex("CollegeUserId");

                            b1.ToTable("RefreshToken");

                            b1.WithOwner()
                                .HasForeignKey("CollegeUserId");
                        });
            ...
            modelBuilder.Entity("CollegeProject.Core.Entities.Message.EmailLog", b =>
                {
                    b.HasOne("CollegeProject.Core.Entities.CollegeUser", "SentUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CollegeProject.Core.Entities.CollegeUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
